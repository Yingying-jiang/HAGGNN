...
class EGNN(nn.Module):
    ...
    def forward(self, batched_graph, h, x, edges, edge_attr, water_shell_layers):
...
class HAEGNN(nn.Module):
    def __init__(self, egnn_params, act_fn=nn.SiLU()):
        super().__init__()
        self.egnn = EGNN(**egnn_params)
        self.pool_dim = egnn_params['output_nf'] * 2
